...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::collection::upsert_collection_element,
            ...
            commands::collection::get_collection_element,
            commands::collection::delete_collection_element,
            commands::collection::get_not_registered_detail_erogamescape_ids,
            commands::collection::get_collection_ids_by_erogamescape_ids,
            commands::collection_details::upsert_collection_element_details,
            ...
            commands::work_omit::work_omit_add,
            commands::work_omit::work_omit_remove,
            commands::work_omit::work_omit_all,
            commands::work_details::get_work_details_all,
            commands::work_details::get_work_details_by_collection_element,
            commands::dmm_pack::work_pack_add,
            commands::dmm_pack::work_pack_remove,
            commands::dmm_pack::work_pack_all,
            commands::works::list_work_lnks,
            commands::works::launch_work,
            commands::works::migrate_collection_paths_to_work_lnks,
            commands::image_queue::get_image_save_queue,
            commands::dmm_pack::get_parent_dmm_pack_keys,
        ])
