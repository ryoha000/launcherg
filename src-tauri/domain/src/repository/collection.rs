...
pub trait CollectionRepository {
    ...
    async fn get_element_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElement>>;
    ...
    async fn upsert_collection_element_paths(&mut self, paths: &NewCollectionElementPaths) -> Result<()>;
    async fn get_element_paths_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementPaths>>;

    async fn upsert_collection_element_install(&mut self, install: &NewCollectionElementInstall) -> Result<()>;
    async fn get_element_install_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementInstall>>;

    async fn upsert_collection_element_play(&mut self, play: &NewCollectionElementPlay) -> Result<()>;
    async fn get_element_play_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementPlay>>;
    async fn update_element_last_play_at_by_id(&mut self, id: &Id<CollectionElement>, last_play_at: DateTime<Local>) -> Result<()>;

    async fn upsert_collection_element_like(&mut self, like: &NewCollectionElementLike) -> Result<()>;
    async fn delete_collection_element_like_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<()>;
    async fn get_element_like_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementLike>>;
    async fn update_element_like_at_by_id(&mut self, id: &Id<CollectionElement>, like_at: Option<DateTime<Local>>) -> Result<()>;

    async fn upsert_collection_element_thumbnail(&mut self, thumbnail: &NewCollectionElementThumbnail) -> Result<()>;
    async fn get_element_thumbnail_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementThumbnail>>;
    async fn upsert_collection_element_thumbnail_size(&mut self, id: &Id<CollectionElement>, width: i32, height: i32) -> Result<()>;
    async fn get_null_thumbnail_size_element_ids(&mut self) -> Result<Vec<Id<CollectionElement>>>;

    async fn get_element_erogamescape_by_element_id(&mut self, id: &Id<CollectionElement>) -> Result<Option<CollectionElementErogamescape>>;

    async fn get_collection_id_by_erogamescape_id(&mut self, erogamescape_id: i32) -> Result<Option<Id<CollectionElement>>>;
    async fn get_collection_ids_by_erogamescape_ids(&mut self, erogamescape_ids: &[i32]) -> Result<Vec<(i32, Id<CollectionElement>)>>;
    async fn upsert_erogamescape_map(&mut self, collection_element_id: &Id<CollectionElement>, erogamescape_id: i32) -> Result<()>;
